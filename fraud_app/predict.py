...
# setting priority levels for fraud
...
# unpack ticket values - you know the drill by now
...
# add TF-IDF engineered features
...
def main():
    ...
    df, result, priority, name = convert_data_and_return_pred(df,bnb_d,bnb_od_p,bnb_od_r,tf_d,tf_od_p,tf_od_r,rf_mod)
    return df, result, priority, name
