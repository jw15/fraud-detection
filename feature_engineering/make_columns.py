...
def create_save_file(tf,bnb,file_p,X,y): # create save file for numpy arrays to be saved for export
    ...
    y_proba = bnb.predict_proba(X_tran)
...
if __name__ == '__main__':
    ...
    create_save_file(tf_d,bnb_d,'../data/description_pred.npy',X_des,y) # saving predictions
    create_save_file(tf_od_p,bnb_od_p,'../data/org_description_pred_p.npy',X_org,y)
    X_parsed = parse_X(X_org)
    create_save_file(tf_od_r,bnb_od_r,'../data/org_description_pred_r.npy',X_parsed,y)
